...
write.csv(div_by_sample, "Tables/Class_Shannon_Diversity_PerSample.csv", row.names = F)
...
ggsave("Plots/Fig7_Shannon_All_Litter.png", p_shannon, width = 10, height = 7, dpi = 300)
